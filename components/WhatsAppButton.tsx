...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ 
  ...
  const variants = {
    ...
    // Adjusted floating: bottom-4 on mobile to avoid covering too much, bottom-8 on desktop.
    // Added z-50 to ensure it's above other content but below modals if any.
  ...
  return (
    <a 
      ...
      aria-label={label || "Contato WhatsApp"}
      onClick={handleClick}
    >
